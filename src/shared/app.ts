...
import teamMemberRoutes from "../modules/team-member/routes";
...
app.use("/team-invitation", teamInvitationRoutes);
app.use("/team-member", checkPermission, teamMemberRoutes);
